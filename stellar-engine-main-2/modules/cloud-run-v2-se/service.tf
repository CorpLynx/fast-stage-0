...
resource "google_cloud_run_v2_service" "service" {
  ...
  dynamic "binary_authorization" {
    for_each = var.binary_authorization_mode != "disabled" ? [1] : []
    content {
      use_default = var.binary_authorization_mode == "default" ? true : null
      policy      = var.binary_authorization_mode == "policy" ? var.binary_authorization_policy : null
    }
  }
  template {
