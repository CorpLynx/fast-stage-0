...
variable "binary_authorization_mode" {
  description = "Mode for Binary Authorization. Can be 'default', 'policy', or 'disabled'"
  type        = string
  default     = "disabled" # Or "default"
  validation {
...
variable "binary_authorization_policy" {
  description = "The resource name of the Binary Authorization policy to use (e.g., projects/PROJECT_ID/policies/POLICY_ID). Required if binary_authorization_mode is 'policy'."
  type        = string
  default     = null
}
